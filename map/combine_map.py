...
combine_range_x = max(obstacle_range_x, odometry_range_x)
combine_range_y = max(obstacle_range_y, odometry_range_y)
...
for i in range(obstacle_range_x):
    for j in range(obstacle_range_y):
        combine[i+combine_origin_x-obstacle_origin_x][j+combine_origin_y-obstacle_origin_y] += obstacle[i][j]
for i in range(odometry_range_x):
    for j in range(odometry_range_y):
